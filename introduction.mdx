...
<Note>
  **Not sure where to begin?** Use [Start Here by Role](/start-here-by-role) to choose the fastest path for API builders, AI-agent builders, or team admins.
</Note>
...
Choose the onboarding path that matches your implementation:

<CardGroup cols={3}>
  <Card title="General API build" icon="code" href="/api-reference/v2-introduction">
    Build with Search, Scrape, Interact, Crawl, Map, and Agent endpoints.
  </Card>
  <Card title="AI-agent onboarding" icon="robot" href="/ai-onboarding">
    Install Skills + CLI, configure auth, and connect Firecrawl to agent workflows.
  </Card>
  <Card title="MCP client setup" icon="plug" href="/mcp-server">
    Configure Firecrawl MCP for Claude, Cursor, VS Code, Windsurf, and more.
  </Card>
</CardGroup>
